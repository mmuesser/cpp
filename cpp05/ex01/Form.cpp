...
/*   Updated: 2024/01/16 11:10:13 by mmuesser         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::Form(const Form &obj) : _name(obj.getName()), _sign(obj.getSign()), _sign_grade(obj.getSignGrade()), _exec_grade(obj.getExecGrade())
{
